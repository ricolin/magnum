...
RULE_ADMIN_OR_PROJECT_MEMBER_CLUSTER_USER = (
    'rule:admin_or_project_member_cluster_user')
...
# ==========================================================
# Deprecated Since OpenStack 2023.1(Magnum 16.0.0) and should be removed in
# The following cycle.

DEPRECATED_REASON = """
The Magnum service now enables policies (RBAC) new defaults and scope by
default. And seperate project reader APIs and project member APIs.
"""
